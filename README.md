...
- Capture load index and optional speed index in each tyre line.
...
- Service worker uses network-first updates so app cache refreshes when a new version is available.
